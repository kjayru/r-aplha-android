...
/**
 Base class for all RetoALPHA views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the RetoALPHA view hierarchy (such as wrapped iOS UIViews) was touched.
