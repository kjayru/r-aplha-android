...
@interface RetoALPHAObject : KrollCoverageObject {
#else
@interface RetoALPHAObject : KrollObject {
#endif
@private
...
extern NSString * RetoALPHA$ModuleRequireFormat;
