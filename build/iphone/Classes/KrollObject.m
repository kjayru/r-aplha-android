...
//@interface RetoALPHAObject : NSObject
//@end

@interface RetoALPHAObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[RetoALPHAObject class]])
		{
			for (NSString *key in [[(RetoALPHAObject*)o modules] allKeys])
			{
