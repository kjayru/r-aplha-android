...
// in simulator we redefine to format for RetoALPHA Developer console
...
{\
	NSString * exceptionName = [@"org.retoalpha." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.retoalpha";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIRetoALPHANativeItemNone = -1, 
	UIRetoALPHANativeItemSpinner = -2,
	UIRetoALPHANativeItemProgressBar = -3,
	
	UIRetoALPHANativeItemSlider = -4,
	UIRetoALPHANativeItemSwitch = -5,
	UIRetoALPHANativeItemMultiButton = -6,
	UIRetoALPHANativeItemSegmented = -7,
	
	UIRetoALPHANativeItemTextView = -8,
	UIRetoALPHANativeItemTextField = -9,
	UIRetoALPHANativeItemSearchBar = -10,
	
	UIRetoALPHANativeItemPicker = -11,
	UIRetoALPHANativeItemDatePicker = -12,
	
	UIRetoALPHANativeItemInfoLight = -13,
	UIRetoALPHANativeItemInfoDark = -14,
	
	UIRetoALPHANativeItemDisclosure = -15,
	
	UIRetoALPHANativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all RetoALPHA instances of
